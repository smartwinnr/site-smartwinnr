          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide swiper-slide-request"> 
                <div class="row">
                  <div class="col-lg-12">
                      <img src="/images/g2badges/mid-market/9.png" class="swiper-img">
                  </div>
                </div>
              </div>
              <div class="swiper-slide swiper-slide-request"> 
              ...
              <div class="swiper-slide swiper-slide-request"> 
                <div class="row">
                  <div class="col-lg-12">
                      <img src="/images/g2badges/mid-market/15.png" class="swiper-img">
                  </div>
                </div>
              </div>
              <div class="swiper-slide swiper-slide-request"> 
                <div class="row">
                  <div class="col-lg-12">
                      <img src="/images/g2badges/mid-market/16.png" class="swiper-img">
                  </div>
                </div>
              </div>
              <div class="swiper-slide swiper-slide-request"> 
                <div class="row">
                  <div class="col-lg-12">
                      <img src="/images/g2badges/asia-pacific/3.png" class="swiper-img">
                  </div>
                </div>
              </div>
              <div class="swiper-slide swiper-slide-request"> 
                <div class="row">
                  <div class="col-lg-12">
                      <img src="/images/g2badges/asia-pacific/4.png" class="swiper-img">
                  </div>
                </div>
              </div>
              <div class="swiper-slide swiper-slide-request"> 
