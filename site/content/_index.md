...
layout: ml_layout
---
<!-- This is a check for deploy build using Ubuntu 20. Changes are done in Netlify server.  -->
<section class="">
...
<section class="ml-key-points ml-background-white">
  <div class="padding50 ml-padding-bottom10">
    ...
    <div class="row text-center paddingLogo">
     ...
     <div class="ml_height_100_flex ml_div_contents_in_center"  >
      <img class="ml_company_logo_home ml_height_30" src="/images/org-logos/Dr_reddys.png" alt="Jr reddys">
   </div>
   <div class="ml_height_100_flex ml_div_contents_in_center"  >
    <img class="ml_company_logo_home  ml_height_30" src="/images/org-logos/viatris-logo.png" alt="Viatris Logo">
 </div>
 <div class="ml_height_100_flex ml_div_contents_in_center"  >
  <img class="ml_company_logo_home ml_height_30" src="/images/org-logos/The_Himalaya_Drug_Company_logo.png" alt="Himalaya Drug Compan">
</div>
<div  class="ml_height_100_flex ml_div_contents_in_center" >
 ...
 <div  class="ml_height_100_flex ml_div_contents_in_center" >
  <img class="ml_company_logo_home ml_height_50"  src="/images/org-logos/Shalina_healthcare.png" alt="Shalina Logo">
   ...
   <div class="ml_height_100_flex ml_div_contents_in_center"  >
    <img class="ml_company_logo_home ml_height_25" src="/images/org-logos/Abbott.png" alt="abbot logo">
 </div>
        <div class="ml_height_100_flex ml_div_contents_in_center">
          <img class="ml_company_logo_home ml_height_25" src="/images/org-logos/JnJ_MedTech.png" alt="JnJ Medtech">
        </div>
        <div class="ml_height_100_flex ml_div_contents_in_center">
...
<div class="ml_height_100_flex ml_div_contents_in_center"  >
  <img class="ml_company_logo_home ml_height_35 ml-margin-top10" src="/images/org-logos/Aadhar_housing_finance.png" alt="Aadhar">
</div>
<div class="ml_height_100_flex ml_div_contents_in_center"  >
...
<div class="ml_height_100_flex ml_div_contents_in_center"  >
  ...
  <div class="ml_height_100_flex ml_div_contents_in_center"  >
    ...
    <div class="ml_height_100_flex ml_div_contents_in_center"  >
       ...
       <div  class="ml_height_100_flex ml_div_contents_in_center">
         <img class="ml_company_logo_home ml_height_40"  src="/images/org-logos/Indian-Immunologicals-Ltd-logo.png" alt="Indian Immunologicals Ltd Logo">
        </div>
       <div  class="ml_height_100_flex ml_div_contents_in_center" >
      ...
      <div class="ml_height_100_flex ml_div_contents_in_center"  >
          <img class="ml_company_logo_home " src="/images/org-logos/nouvmed logo.webp" alt="Nouvmed Logo">
       </div> -->
       <!--
       ...
       <!-- <div class="ml_height_100_flex ml_div_contents_in_center" > 
          <img class="ml_company_logo_home ml_height_40 " src="/images/org-logos/j-j-logo.png" alt="Johnson & Johnson">
       </div>
       
       <div class="ml_height_100_flex ml_div_contents_in_center" >
          <img class="ml_company_logo_home ml_height_75 ml-margin-top10" src="/images/org-logos/artis.png" alt="ASL">
       </div>
       <div class="ml_height_100_flex ml_div_contents_in_center"  >
          <img class="ml_company_logo_home ml_height_75" src="/images/org-logos/tynor-logo.png" alt="Tynor">
       </div>
       <div class="ml_height_100_flex ml_div_contents_in_center"  >
          <img class="ml_company_logo_home ml_height_55" src="/images/org-logos/fitterfly.png" alt="Flitterfly">
       </div>
       <div class="ml_height_100_flex ml_div_contents_in_center"  >
          <img class="ml_company_logo_home ml_height_55" src="/images/org-logos/mfs.png" alt="MFS">
       </div>
        -->
    ...
    <div class="ml-container">
      <div class="row ml-margin-top10">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 text-center">
          <div class="ml-column text-center">
            <h1><span class="icon-arrow-up-circle ml-icon-blue"></span>22%</h1>
            <h4>Quota Attainment</h4>
          </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 text-center">
          <div class="ml-column text-center">
            <h1><span class="icon-arrow-up-circle ml-icon-blue"></span>91%</h1>
            <h4>Increase Engagement</h4>
          </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 text-center">
          <div class="ml-column text-center">
            <h1><span class="icon-arrow-down-circle ml-icon-blue"></span>30%</h1>
            <h4>Reduce Cost</h4>
          </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <div class="ml-column text-center">
            <h1><span class="icon-arrow-up-circle ml-icon-blue"></span>67%</h1>
...
<section class="ml-chooseQP ml-background-white">
  <div class="ml-container">
    <div class="row padding50 ml_div_contents_in_center">
      ...
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 ml-centered-half ml-padding-top0">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-4">
        <div class="single-service padding">
          ...
          <h2 class="ml_body_text_white text-center">Sales teams can’t retain product information</h2>
          <div class="ml_body_text_white ml-subtext">
...
<!-- <section class="ml-background-white">
  <div class="ml-container ml-background-wave">
    <div class="row ml-margin-bottom0">
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 ml-centered ml-margin-top30" align="center">
...
<section class="ml-background-white">
  <div class="ml-container padding50 ml-background-wave-home-page ">
    <div class="row ml-margin-bottom0">
...
<!-- <section class="ml-background-white ml-container">
  <div class="row padding80">
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
      <h2>Built for large, distributed sales teams</h2>
      <div class="row ml-margin-bottom20 ml_special_border">
        <h4 class="ml-title-adjustable ml-title-font">Track and Reinforce Product Information</h4>
        <div class="ml-subtext">Use SmartWinnr’s AI to reinforce key messages regularly, measure and track retention of product information while making it fun and engaging.</div>
      </div>
      <div class="row ml-margin-bottom20 ml_special_border">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-4 ">
          <div class="single-service padding">
            ...
            <h2 class="ml_body_text_white text-center">Built for the Enterprise</h2>
            <div class="ml_body_text_white ml-subtext">
